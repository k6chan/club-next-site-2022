            ...
            <Container className="border-bottom mb-5">
                <Row className="align-items-center mb-5">
                    ...
                    <Col md={6}>
                        ...
                        <p>We&apos;re the anime club at UCSD :D We might seem mysterious at first, but stop by club
                            sometime to
                ...
                <Row className="align-items-center mb-5">
                    <Col md={7}>
                        ...
                        <p>We host anime showings and other activities every Monday evening. We also hang out and
                            organize weekend socials like karaoke, club dinner, etc. Our largest event is our on-campus
